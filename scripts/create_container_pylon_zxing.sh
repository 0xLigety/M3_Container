...
DESCRIPTION="A container with pylon, zxing and mosquitto to read and push qr tags"
CONTAINER_NAME="pylon_zxing_mosquitto"
ROOTFS_LIST="pylon_zxing_mosquitto.txt"
...
echo " "
echo "###################################################################################################"
echo " This creates a container with pylong, zxing and mosquitto MQTT broker in it."
